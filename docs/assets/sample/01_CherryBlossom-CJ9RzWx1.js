import { _ as r, a as t, __tla as __tla_0 } from "../index-Bmbx4PuQ.js";
Promise.all([
    (()=>{
        try {
            return __tla_0;
...
`;
    ...
    r.setting = async function() {
        this.stage.Event.whenFlag(async function*() {
            for(this.Looks.Backdrop.name = "Black", this.Looks.Effect.set(t.ImageEffective.GHOST, 99), this.Sound.add(o.ClassicPiano);;)this.Event.broadcast(g.SOUND_START), await this.Sound.playUntilDone(o.ClassicPiano), yield;
            ...
            for(;;){
                this.Motion.Move.randomPosition(), this.Motion.Position.y = t.randomInteger(100, 180);
                const e = t.randomInteger(10, 50);
                this.Looks.Size.scale = {
                    w: e,
                    h: e
                }, this.Looks.Effect.set(t.ImageEffective.COLOR, t.randomInteger(0, 240)), this.Control.clone(), await this.Control.wait(.05), yield;
            }
        }), i.Control.whenCloned(async function*() {
            this.Looks.show();
            const e = t.randomInteger(-15, 15);
            for(;;){
                const n = (180 - this.Motion.Position.y + 20) / 360;
                if (this.Motion.Position.y -= t.randomInteger(5, 10) * n, this.Motion.Position.x += t.randomInteger(-2, 2), this.Motion.Direction.degree += e, this.Pen.stampStage(), this.Pen.stamp(), this.Motion.Position.y < -170) break;
                yield;
            }
            this.Control.remove();
        });
