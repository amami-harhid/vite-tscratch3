import { _ as c, a as t, __tla as __tla_0 } from "../index-BX_7rBdP.js";
Promise.all([
    (()=>{
        try {
            return __tla_0;
...
`;
    class a {
        ...
        static fontFaceUrl(e) {
            const n = [];
            for (const f of a.texts)for (const h of f)h != " " && (n.includes(h) || n.push(h));
            const l = n.sort().join("");
    ...
    c.setting = async function() {
        r.Event.whenFlag(async function*() {
            for(this.Looks.Backdrop.name = "Black", this.Looks.Effect.set(t.ImageEffective.GHOST, 99), this.Sound.add(o.ClassicPiano);;)this.Event.broadcast(w.SOUND_START), await this.Sound.playUntilDone(o.ClassicPiano), yield;
