import { _ as h, a as t, __tla as __tla_0 } from "../index-Bmbx4PuQ.js";
Promise.all([
    (()=>{
        try {
            return __tla_0;
...
`;
    ...
    h.setting = async function() {
        this.stage.Event.whenFlag(async function*() {
            ...
            for(;;)this.Sensing.Key.isDown(t.Keyboard.RIGHT) && (this.Motion.Position.x += 10), this.Sensing.Key.isDown(t.Keyboard.LEFT) && (this.Motion.Position.x -= 10), yield;
        }), e.Event.whenFlag(async function*() {
            for(this.Sound.add(o.Shot);;)this.Sensing.Key.isDown(t.Keyboard.SPACE) && (a.Control.clone(), this.Sound.play(o.Shot)), yield;
        }), e.Event.whenFlag(async function*() {
            ...
            const s = 10;
            for(this.Looks.show(); !this.Sensing.Edge.isTouching;)this.Motion.Move.steps(s), yield;
            this.Control.remove();
            ...
            const g = t.getRandomValueInRange(-1, 5);
            for(this.Looks.show();;){
                ...
                this.Motion.Position.y += t.randomInteger(-5, 1) / 2, this.Motion.Direction.degree += g, yield;
            }
