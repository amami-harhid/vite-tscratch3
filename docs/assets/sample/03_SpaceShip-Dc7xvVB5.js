import { _ as r, a as t, __tla as __tla_0 } from "../index-BI-1cn8T.js";
Promise.all([
    (()=>{
        try {
            return __tla_0;
...
`;
    ...
    r.prepare = async function() {
        ...
        h.SvgText.addTexts("Text1", [
            "Space ship game"
        ], m), n = new t.Sprite("bottom"), n.SvgText.add(o.Black, u("black")), n.Motion.Position.xy = [
            0,
            -180
        ], n.Looks.Layer.gotoBack(), n.Looks.Effect.set(t.ImageEffective.GHOST, 100), a = new t.Sprite(o.Bullet), a.SvgText.add(o.Bullet, v("white")), a.Looks.Size.scale = [
            10,
            10
