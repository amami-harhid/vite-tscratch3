import { _ as p, a as e, __tla as __tla_0 } from "../index-BP3kCZCx.js";
Promise.all([
    (()=>{
        try {
            return __tla_0;
...
`, i = {
    ...
    p.prepare = async function() {
        f = new e.Stage, f.Sound.add(y), f.SvgText.add("BackDrop", b), l = new e.Sprite(u), l.Font.add(i.GoogleFontsJPGuidance), l.Looks.hide();
        ...
        h = new e.Sprite(u), h.Font.add(i.GoogleFontsEN), h.Looks.hide();
    ...
    p.setting = async function() {
        ...
        }), h.Event.whenBroadcastReceived("Start2", async function*() {
            for(this.Looks.Size.scale = {
                w: 150,
                h: 150
